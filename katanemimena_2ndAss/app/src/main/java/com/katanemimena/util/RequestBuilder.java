...
public class RequestBuilder {
    ...
    public static String createSearchRequest(String artist){ //requests pou epistrefei json
        try{
    ...
    public static String createRegisterInDistributedSystemRequest(){ //1h fora gia na xrisimopoihsei to broker
        try{
            JSONObject request = new JSONObject();
            request.put("sender", CUSTOMER_IDENTITY);
            return request.toString();
